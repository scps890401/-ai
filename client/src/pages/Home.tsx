...
import { shouldOpenFeedbackFromHash, validateFeedbackMessage } from "@/lib/feedbackUi";
...
export default function Home() {
  ...
  const publicFeedback = trpc.feedback.publicList.useQuery();
  ...
  async function createSticker() {
    ...
    const sources = uploaded.slice(0, 4);
