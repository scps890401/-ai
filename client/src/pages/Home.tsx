...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <main id="top">
      <section className="hero section-pad hero-simplified"><div className="ambient orb-one" /><div className="ambient orb-two" /><div className="hero-copy reveal"><div className="eyebrow">AI 智能創作 · 全程在網頁內完成</div><h1>把照片變成<br /><span>你的專屬貼圖</span></h1><p className="hero-lead">上傳一張照片，選一種風格與幾個表情，幾秒就能完成一套可預覽、可下載、可分享的貼圖。</p><div className="hero-actions"><button className="button button-primary" onClick={() => scrollToId("studio")}><Wand2 size={16} />立即開始製作</button><button className="button button-secondary" onClick={() => scrollToId("gallery")}><ImageIcon size={16} />看看作品靈感</button></div><div className="trust-row"><span><Check size={14} />瀏覽器內完成</span><span><Check size={14} />免費使用</span><span><Check size={14} />可直接下載</span></div></div></section>
